...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', nargs='+', type=str,
                        default=[os.path.abspath(os.path.join(script_path, '../rt_gene/model_nets/blink_model_resnet50_f0.model')),
                                 os.path.abspath(os.path.join(script_path, '../rt_gene/model_nets/blink_model_resnet50_f1.model')),
                                 os.path.abspath(os.path.join(script_path, '../rt_gene/model_nets/blink_model_resnet50_f1.model'))],
