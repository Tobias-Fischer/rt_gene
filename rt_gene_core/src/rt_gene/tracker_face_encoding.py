...
class FaceEncodingTracker(GenericTracker):
    ...
    def __init__(self, threshold=0.6):
        ...
        if FaceEncodingTracker.FACE_ENCODER is None:
            FaceEncodingTracker.FACE_ENCODER = dlib.face_recognition_model_v1(
                str(model_path('dlib_face_recognition_resnet_model_v1.dat')))
